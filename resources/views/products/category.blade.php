                        ...
                        <ol role="list" class="flex items-center space-x-4">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('products.index') }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">Productos</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
                ...
                @empty
                    <div class="col-span-full">
                        <div class="text-center py-12">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No hay productos en esta categoría</h3>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">No se encontraron productos en la categoría "{{ $category->name }}".</p>
                            <div class="mt-6">
